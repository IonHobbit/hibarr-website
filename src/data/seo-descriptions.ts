...
type SeoDescriptions = {
    [key in Locale]: {
        [page: string]: string;
    };
};

export const seoDescriptions: SeoDescriptions = {
    en: {
        home: "Invest in North Cyprus real estate with HIBARR. 10-year payment plans, 0% interest, no credit check. Access exclusive properties with high ROI and 15% annual yields.",
        about: "Learn about HIBARR's mission to revolutionize North Cyprus real estate. We connect investors with high-yield opportunities, offering transparency and expert guidance.",
        packages: "Explore HIBARR's exclusive property packages. From studios to luxury villas, find the perfect investment with flexible payment plans and guaranteed rental income.",
        listings: "Browse our curated list of North Cyprus properties. Sea-view apartments, luxury villas, and investment opportunities with high capital appreciation potential.",
        testimonials: "See what our investors say about HIBARR. Read success stories and reviews from satisfied clients who have successfully invested in North Cyprus real estate.",
    ...
    de: {
        ...
        about: "Erfahren Sie mehr über HIBARRs Mission für Immobilien in Nordzypern. Wir verbinden Investoren mit renditestarken Chancen, Transparenz und Expertenberatung.",
        packages: "Entdecken Sie HIBARRs exklusive Immobilienpakete. Von Studios bis zu Luxusvillen – finden Sie die perfekte Investition mit flexiblen Zahlungsplänen.",
        listings: "Durchsuchen Sie unsere Auswahl an Immobilien in Nordzypern. Apartments mit Meerblick, Luxusvillen und Investitionsmöglichkeiten mit hohem Wertsteigerungspotenzial.",
        testimonials: "Das sagen unsere Investoren über HIBARR. Lesen Sie Erfolgsgeschichten und Bewertungen von zufriedenen Kunden, die erfolgreich in Nordzypern investiert haben.",
    ...
    tr: {
        ...
        about: "HIBARR'ın Kuzey Kıbrıs gayrimenkul sektöründeki misyonunu keşfedin. Yatırımcıları yüksek getirili fırsatlar, şeffaflık ve uzman rehberliği ile buluşturuyoruz.",
        packages: "HIBARR'ın özel gayrimenkul paketlerini inceleyin. Stüdyolardan lüks villalara, esnek ödeme planları ve garantili kira geliri ile ideal yatırımınızı bulun.",
        listings: "Kuzey Kıbrıs'taki seçkin emlak ilanlarına göz atın. Deniz manzaralı daireler, lüks villalar ve yüksek değer artışı potansiyeline sahip yatırım fırsatları.",
        testimonials: "Yatırımcılarımızın HIBARR hakkında neler söylediğini görün. Kuzey Kıbrıs'ta başarıyla yatırım yapmış mutlu müşterilerimizin başarı hikayelerini okuyun.",
    ...
    ru: {
        ...
        about: "Узнайте о миссии HIBARR на рынке недвижимости Северного Кипра. Мы предлагаем инвесторам высокодоходные возможности, прозрачность и экспертную поддержку.",
        packages: "Изучите эксклюзивные пакеты недвижимости HIBARR. От студий до роскошных вилл — найдите идеальную инвестицию с гибкими планами оплаты.",
        listings: "Просмотрите наш каталог недвижимости на Северном Кипре. Апартаменты с видом на море, виллы и инвестиционные объекты с высоким потенциалом роста стоимости.",
        testimonials: "Узнайте, что говорят инвесторы о HIBARR. Читайте истории успеха и отзывы довольных клиентов, успешно инвестировавших в недвижимость Северного Кипра.",
