    ...
    <section id='consultation-process' className='section'>
      <div className="bg-primary rounded-lg p-6 md:p-9 flex flex-col gap-6">
        <div className="max-w-screen-lg mx-auto flex flex-col gap-3">
          <h3 className='text-3xl md:text-4xl text-center text-primary-foreground'>{data?.title}</h3>
            ...
            <div
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs md:text-base text-accent uppercase font-medium md:whitespace-nowrap">{step.subtitle}</p>
                </div>
              </div>
