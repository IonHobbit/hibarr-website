...
export const fetchDocumentTransactionIDs = async (id: string): Promise<string[]> => {
...
export const fetchDocumentHistory = async (documentId: string, revisionId: string): Promise<object> => {
...
export const fetchLanguageVersionsOfType = async (type: string): Promise<{ _id: string, language: string }[]> => {
...
export const updateDocument = async (documentId: string, changes: Record<string, unknown>) => {
  const payload = {
    mutations: [
      {
        patch: {
...
export const translateChanges = async (changes: Record<string, unknown>, targetLanguage: TargetLanguageCode) => {
...
export function compareArrays(current: unknown[], previous: unknown[], path: string[]): Record<string, unknown> {
