...
export default function ClientHeader({ lang, navigationData }: ClientHeaderProps) {
  ...
  return (
    <header className={cn("absolute top-0 z-20 w-full h-[75px] flex items-center", isExcludedPath ? "bg-transparent mt-3" : "bg-gradient-to-b from-primary/90 to-transparent")}>
